...
const Experience = () => {
    ...
    const currentLanguange=(i18n.resolvedLanguage) as TLanguage;
    return (
        <Row className="mb-5">
                                ...
                                <div className="p-3 relative">
                                    ...
                                    <div className="experience-container">
                                        <div className="duration-text">
                                            <p>{experience.duration[currentLanguange]}</p>
                                        </div>
                                        <div className="details">
                                            ...
                                            <div className="info">
                                                <p className="title">{experience.title[currentLanguange]}</p>
                                                <p className="company">{experience.company[currentLanguange]}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
